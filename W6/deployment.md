...
## 4. Bản dự phòng (backup)

* **Link file zip (`src/` chạy offline):** *(điền sau khi hoàn thành Task 4)*
* **Link video quay màn hình (Arena 1 → bảng tổng kết):** *(điền sau khi hoàn thành Task 4)*

## 5. Vấn đề phát sinh khi deploy (nếu có)
