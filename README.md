...
Chịu trách nhiệm bảo đảm tất cả module hoạt động trên cùng một kiến trúc.

### Sản phẩm cuối cùng

- cấu trúc 5 Area + Side Quest;
- 10 Level + 1 Boss mỗi Area;
- logic unlock;
- Player Progress;
- Final Boss unlock;
- integration các module;
- pseudocode tổng thể.
...
> **Chốt kiến trúc chung trước khi các thành viên bắt đầu phát triển độc lập.**

Deliverables:

- Game Flow Chart;
- danh sách biến dùng chung;
- cấu trúc folder/code;
...
Chịu trách nhiệm cho phần dữ liệu câu hỏi và logic quiz.

### Sản phẩm cuối cùng

- phân loại câu hỏi theo Area;
- lấy câu hỏi theo Area/Level;
- tránh duplicate trong Level;
- kiểm tra đáp án;
- Pts;
- MPS;
- Pass/Fail;
...
Thiết kế một format dữ liệu chung cho mọi câu hỏi:
...
> **Các module khác có thể sử dụng question bank mà không cần tự định nghĩa lại cấu trúc dữ liệu.**

---

### Trang — Special Mechanics Developer

Chịu trách nhiệm tạo sự đa dạng cho game thông qua các mechanics đặc biệt.
...
Tập trung vào cơ chế:

> **Trap có 20% khả năng xuất hiện trong Normal Level.**

Cần xác định:

- thời điểm roll probability;
- điều kiện Trigger;
- cách chuyển từ Normal Level sang Trap;
- cách trả trạng thái về flow chính sau Trap.



### Minh — Player Points + Shop + Inventory Developer

Chịu trách nhiệm cho hệ thống kinh tế của game.
...
> **Tất cả module sử dụng chung một nguồn dữ liệu điểm và Item, tránh mỗi module tự lưu một trạng thái riêng.**

---

### Khôi — Frontend/UI + Result Analytics + QA Lead

Chịu trách nhiệm biến toàn bộ logic của nhóm thành một trải nghiệm mà người dùng có thể tương tác.
...
> **Wireframe và UI Flow trước khi code.**

Các màn hình cần xác định trước:
