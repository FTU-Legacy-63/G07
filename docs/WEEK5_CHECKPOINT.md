...
|---|---|---|---|---|
| **Quỳnh** | code + logic | • User flow: happy path 14 bước, alternative path, error path 7 tình huống<br>• Feature scope: main / supporting / optional feature, ranh giới Core–Optional, out of scope<br>• Ba công thức tính điểm: `accuracy_cumulative`, `arena_score_correct`, `performance_score` (quy đổi độ khó 1/2/3 điểm)<br>• Biến trạng thái; luật phân định khi hai cụm bằng tỷ lệ đúng; quy tắc loại câu dùng vật phẩm khỏi mẫu chẩn đoán<br>• Bảng tổng kết sau Boss với 4 điều kiện kết luận<br>• File Excel minh hoạ một lượt chơi <br>• Macro VBA<br>• Tài liệu: `SOLUTION_STRUCTURE`, `INPUT_DICTIONARY`, `ASSUMPTIONS`, `SOURCE_USE_MAP`, `SAMPLE_INPUT_OUTPUT`, `MIDTERM_REVIEW`, `README`<br>• Rà soát, hoàn thiện bản cuối ngân hàng câu hỏi; tích hợp các phần thành demo | [`docs/user-flow.md`](user-flow.md)<br>[`docs/feature-scope.md`](feature-scope.md)<br>[`SOLUTION_STRUCTURE.md` Mục 5](SOLUTION_STRUCTURE.md#5-c%C6%A1-ch%E1%BA%BF-l%C3%B5i--ch%E1%BA%A9n-%C4%91o%C3%A1n-v%C3%A0-b%E1%BA%ABy), [Mục 7](SOLUTION_STRUCTURE.md#7-user-flow)<br>[`INPUT_DICTIONARY.md` Mục 3](INPUT_DICTIONARY.md#3-state-variables--h%E1%BB%87-th%E1%BB%91ng-t%E1%BB%B1-t%C3%ADnh-kh%C3%B4ng-ai-nh%E1%BA%ADp-v%C3%A0o), [Mục 4](INPUT_DICTIONARY.md#4-ba-kh%C3%A1i-ni%E1%BB%87m-tr%E1%BA%A3-l%E1%BB%9Di-%C4%91%C3%BAng)<br>[`W4/CFA_Quest_user_flow.xlsm`](../W4/CFA_Quest_user_flow.xlsm)<br>[`W4/VBA_CFA_Quest.bas`](../W4/VBA_CFA_Quest.bas)<br>[`cfa_quest_v11.js` khối 6 (Tính toán)](../src/cfa_quest_v11.js#L351-L488)<br>[`cfa_quest_v11.js` khối 13 (Bảng tổng kết)](../src/cfa_quest_v11.js#L975-L1046) | Công thức ở khối 6 xác định W1, W2 và 3 cụm vào Boss; file Excel dùng để kiểm chứng công thức bằng tay trước khi code và làm demo; user flow là khung cho các màn hình |
| **Hồng** | nội dung | • 110 câu hỏi, 22 câu × 5 cụm, phủ đủ 9 module<br>• Mỗi câu 13 trường: đề, 3 phương án, đáp án, lời giải (`explanation`), lý do gây nhiễu cho từng phương án sai (`distractor_reason`), gợi ý (`hint`)<br>• Gắn nhãn `cluster`, `module`, `sub_standard`, `difficulty` cho từng câu | [`data/ethics_bank_110.json`](../data/ethics_bank_110.json)<br>[`data/questions.js`](../data/questions.js)<br>[`src/cfa_quest_v11_bank.js`](../src/cfa_quest_v11_bank.js) | Engine lọc câu theo `cluster` / `module` khi sinh đề; `difficulty` là trọng số của `performance_score`; `explanation` hiện ở màn kết quả; `sub_standard` là nội dung của Cuộn Giấy Gợi Ý |
| **Trang** | logic + code | • Quy tắc sinh 5 Arena: Arena 1 lấy 3 câu × 5 cụm, rải hết 9 module, đủ 3 mức khó; Trap lấy 10 câu của cụm yếu, chia đều module; Crossroads 2 câu × 5 cụm; Boss 7/5/3<br>• Ràng buộc Trap II nhắm cụm khác Trap I (W2 ≠ W1)<br>• Chống lặp câu trong một lượt; lấy bù câu cũ khi cụm hết câu<br>• Kiểm tra ràng buộc ngân hàng: id trùng, đủ 3 phương án, `cluster` khớp `module`, đáp án đúng không phải phương án dài nhất, lý do gây nhiễu không tái sử dụng | [`SOLUTION_STRUCTURE.md` Mục 2 (ba quy tắc phủ module)](SOLUTION_STRUCTURE.md#ba-quy-t%E1%BA%AFc-b%E1%BA%A3o-%C4%91%E1%BA%A3m-ph%E1%BB%A7-h%E1%BA%BFt-9-module)<br>[`SOLUTION_STRUCTURE.md` Mục 4](SOLUTION_STRUCTURE.md#4-c%E1%BA%A5u-tr%C3%BAc-h%E1%BA%A7m-ng%E1%BB%A5c--5-arena)<br>[`cfa_quest_v11.js` khối 5 (Sinh đề)](../src/cfa_quest_v11.js#L236-L350)<br>[`rankClusters(..., [S.w1])` khi chọn W2](../src/cfa_quest_v11.js#L842)<br>[`tools/validate_question_bank.html`](../tools/validate_question_bank.html) | `buildArena` chạy mỗi lần chuyển Arena; công cụ kiểm tra dùng để QA ngân hàng câu hỏi trước khi nhúng vào demo |
| **Minh** | logic + code | • Cơ chế Credit: khởi đầu 3; đỗ được 2 / 3 / 4 Credit theo mức 70 / 80 / 90%; +5 khi vượt Boss lần đầu<br>• Hai vật phẩm: Bùa Loại Trừ (3 Credit, loại 1 phương án sai), Cuộn Giấy Gợi Ý (4 Credit, hiện Standard đang áp dụng)<br>• Luật dùng: Arena 1 và Boss không dùng; mỗi Arena tối đa 1; mỗi câu tối đa 1 | [`SOLUTION_STRUCTURE.md` Mục 8](SOLUTION_STRUCTURE.md#8-%C4%91%E1%BB%97tr%C6%B0%E1%BB%A3t-credit-shop)<br>[`cfa_quest_v11.js` khối 1 (`creditTiers`, `ITEMS`)](../src/cfa_quest_v11.js#L14-L73)<br>[`creditFor()`](../src/cfa_quest_v11.js#L445-L448)<br>[`renderItemBox`, `useItem`](../src/cfa_quest_v11.js#L767-L808)<br>[`cfa_quest_v11.js` khối 12 (Shop)](../src/cfa_quest_v11.js#L937-L974) | Credit cộng sau mỗi Arena; ô vật phẩm chỉ mở ở Trap I, Crossroads, Trap II |
| **Khôi** | UI + QA | • Giao diện: màn làm bài, màn kết quả sau mỗi Arena, bảng tiến trình, Shop, bảng tổng kết sau Boss<br>• Kiểm thử đường lỗi E1–E7<br>• Đối chiếu chéo các file | [`src/cfa_quest_v11.html`](../src/cfa_quest_v11.html)<br>[`src/cfa_dungeon_ui_v10_skipfix_updated.css`](../src/cfa_dungeon_ui_v10_skipfix_updated.css)<br>[`cfa_quest_v11.js` khối 7–9 (giao diện)](../src/cfa_quest_v11.js#L489-L637)<br>[`cfa_quest_v11.js` khối 11 (màn kết quả)](../src/cfa_quest_v11.js#L867-L936) | Người chơi thao tác trên các màn này; kết quả đối chiếu dùng để sửa chỗ lệch giữa tài liệu và code |
---
